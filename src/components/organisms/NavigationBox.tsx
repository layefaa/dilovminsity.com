...
import {navBoxVariants} from "@/utils/motion";
      ...
      <AnimatePresence>
        {isOpen && (
            <m.div
                ...
                className={`filter fixed z-10 h-screen w-screen pt-[7.5rem] md:pt-[8rem] ${styles.containerPaddingX2} ${isOpen ? 'flex flex-row' : 'hidden'}`}>
